...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, rgba(255,255,255,0.95) 0%, rgba(249,247,244,0.95) 100%), url(/manus-storage/marble-background_8e7c5f9a.png)', backgroundSize: 'cover', backgroundAttachment: 'fixed' }}>
      {/* Navegação */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-amber-100">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src="/manus-storage/italo-logo-simple_7c0e6729.png" alt="Logo" className="h-10 w-10" />
      ...
      <section id="about" className="py-20 container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="rounded-lg overflow-hidden shadow-2xl">
            <img src="/manus-storage/italo-perfil_a58f85a9.jpg" alt="Italo Freitas" className="w-full h-auto" />
          </div>
          <div>
            <div className="flex items-center gap-3 mb-4">
              <img src="/manus-storage/1000166438_d4681af7.png" alt="Alianças" width="32" height="32" style={{ objectFit: 'contain' }} />
      ...
      <footer className="py-8 text-center border-t border-amber-100">
        ...
        <p style={{ color: '#999' }} className="flex items-center justify-center gap-2">Desenvolvido com elegância, profissionalismo e amor ❤️
          <img src="/manus-storage/1000166438_d4681af7.png" alt="Alianças" width="20" height="20" style={{ objectFit: 'contain', opacity: 0.7 }} />
        </p>
      </footer>
    </div>
  );
